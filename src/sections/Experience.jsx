const experiences = [
  ...
  },
  {
    ...
    technologies: ["React", "Node.js", "Express", "MySQL", "MongoDB", "JavaScript"],
    current: true,
  }
];
    ...
    <section id="experience" className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl mb-16">
          ...
          >
            A timeline of my development journey — from self-directed learning to delivering full stack projects through a structured internship program.
          </p>
        </div>
